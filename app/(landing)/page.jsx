...
import { FooterBox, MainBox, OverlayBox } from "#/app/(landing)/interface-boxs";
import { MainButtons, FooterButtons } from "#/app/(landing)/link-buttons";
...
export const metadata = {
  ...
  description:
    "Революционный дневник трейдера, предназначенный для улучшения стратегии вашей торговли.",
};
