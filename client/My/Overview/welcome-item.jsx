      ...
      <Grid item xs={12} md={8}>
        ...
        >
          ...
          >
            ...
            >
              Рады тебя видеть в нашем сервисе!
              <br />
              Перед началом работы добавь новый API-ключ
              <br />
              во вкладке «Ключи» на странице аккаунта.
              <br />
              Также, для понятия устройства сервиса, рекомендуем тебе прочитать
              наш FAQ
            </Typography>
            <Box
              sx={{
